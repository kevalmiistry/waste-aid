...
const Welcome: NextPageWithLayout<IWelcome> = () => {
    return (
        <main
            id="landing-page"
            className={`min-h-screen ${S.main} overflow-x-hidden`}
        >
            <section
                id="hero"
                className="flex min-h-screen flex-col justify-between gap-9 lg:flex-row"
            >
                <div className="z-[10] flex flex-[1.25] flex-col items-center justify-center gap-4 pl-[0rem] lg:items-start xl:pl-[6rem]">
                ...
                <div
                    className={`relative flex flex-1 justify-start md:items-end md:justify-center`}
                >
