...
export const WAFullLogo: FC<IWALogo> = ({ className }) => (
    <div className={twMerge("h-[40px] w-auto", className)}>
        <svg
...
export const WAIconLogo: FC<IWALogo> = ({ className }) => (
    <div className={twMerge("h-[40px] w-auto", className)}>
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={"100%"}
        ...
        >
            <g clipPath="url(#clip0_6_6)">
                <path
                    fill="#000"
                    d="M391 102.291H40l71.5 255.688h68.575l36.075-130.281 35.425 130.281H319.5L391 102.291z"
                />
                <path
                    fill="#96D905"
                    stroke="#000"
                    strokeWidth="6"
                    d="M378 82H27l71.5 255.688h68.575l36.075-130.281 35.425 130.281H306.5L378 82z"
                />
            </g>
            <defs>
